...
interface AuthApi {
    ...
    @POST("rpc/rpc_accept_member")
    suspend fun acceptMember(
        @Body request: Map<String, String>
    ): Response<JsonObject>

    @POST("rpc/rpc_reject_member")
    ...
    @POST("rpc/remove_household_member")
    suspend fun removeMember(
        @Body request: Map<String, String>
    ): Response<JsonObject>

    @POST("rpc/delete_household")
    suspend fun deleteHousehold(
        @Body params: Map<String, String>
    ): Response<Void>

    // ── Actualizar apariencia del hogar (imagen / gradiente) ────────────
    @POST("rpc/rpc_update_household_appearance")
